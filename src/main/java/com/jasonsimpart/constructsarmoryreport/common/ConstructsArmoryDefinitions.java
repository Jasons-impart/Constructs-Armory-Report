...
import com.jasonsimpart.constructsarmoryreport.common.stat.ArmorStatProvider;
...
public class ConstructsArmoryDefinitions {
  ...
  public static final ModifiableArmorMaterial MATERIAL_ARMOR =
      ModifiableArmorMaterial.builder(ConstructsArmoryReport.getResource("material_armor"))
